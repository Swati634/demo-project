...
//======async function example-1======

async function fun() {
  console.log("Fun");
  const rest1 = await new Promise((resolve) => setTimeout(() => resolve("1")));
  console.log(rest1, "rest1 value:");

  const rest2 = await new Promise((resolve) =>
